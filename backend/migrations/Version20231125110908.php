 ...
 */
final class Version20231125110908 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, edition_id INT NOT NULL, name VARCHAR(255) NOT NULL, trailer VARCHAR(255) DEFAULT NULL, dev VARCHAR(255) NOT NULL, editor VARCHAR(255) NOT NULL, `release` DATETIME DEFAULT NULL, description LONGTEXT NOT NULL, old_price INT DEFAULT NULL, price INT DEFAULT NULL, img VARCHAR(255) DEFAULT NULL, stock INT DEFAULT NULL, UNIQUE INDEX UNIQ_D34A04AD74281A5E (edition_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
