 ...
 */
final class Version20241117031056 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE address (id INT AUTO_INCREMENT NOT NULL, housenumber VARCHAR(255) DEFAULT NULL, street VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, postcode INT NOT NULL, is_active TINYINT(1) NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE platform (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, is_physical TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE point (id INT AUTO_INCREMENT NOT NULL, test_id INT DEFAULT NULL, description VARCHAR(255) NOT NULL, is_positive TINYINT(1) NOT NULL, INDEX IDX_B7A5F3241E5D0459 (test_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, edition_id INT DEFAULT NULL, category_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, trailer VARCHAR(255) DEFAULT NULL, dev VARCHAR(255) NOT NULL, editor VARCHAR(255) NOT NULL, `release` DATETIME DEFAULT NULL, description LONGTEXT NOT NULL, old_price INT DEFAULT NULL, price INT DEFAULT NULL, img VARCHAR(255) DEFAULT NULL, stock INT DEFAULT NULL, INDEX IDX_D34A04AD74281A5E (edition_id), INDEX IDX_D34A04AD12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE side_images (id INT AUTO_INCREMENT NOT NULL, product_id INT DEFAULT NULL, img VARCHAR(255) DEFAULT NULL, INDEX IDX_3C7152444584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tag (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE test (id INT AUTO_INCREMENT NOT NULL, product_id INT DEFAULT NULL, user_id INT DEFAULT NULL, comment LONGTEXT NOT NULL, rate INT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_D87F7E0C4584665A (product_id), INDEX IDX_D87F7E0CA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, birthdate DATE NOT NULL, is_verified TINYINT(1) NOT NULL, token VARCHAR(255) DEFAULT NULL, pseudo VARCHAR(255) NOT NULL, token_expiration DATETIME DEFAULT NULL, token_mail VARCHAR(255) DEFAULT NULL, mail_expiration DATETIME DEFAULT NULL, mail_to_update VARCHAR(255) DEFAULT NULL, img VARCHAR(255) DEFAULT NULL, token_password VARCHAR(255) DEFAULT NULL, password_expiration DATETIME DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE vote (id INT AUTO_INCREMENT NOT NULL, test_id INT DEFAULT NULL, user_id INT DEFAULT NULL, vote TINYINT(1) DEFAULT NULL, INDEX IDX_5A1085641E5D0459 (test_id), INDEX IDX_5A108564A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE wishlist (id INT AUTO_INCREMENT NOT NULL, product_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_9CE12A314584665A (product_id), INDEX IDX_9CE12A31A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE point ADD CONSTRAINT FK_B7A5F3241E5D0459 FOREIGN KEY (test_id) REFERENCES test (id)');
        ...
        $this->addSql('ALTER TABLE side_images ADD CONSTRAINT FK_3C7152444584665A FOREIGN KEY (product_id) REFERENCES product (id)');
        ...
        $this->addSql('ALTER TABLE vote ADD CONSTRAINT FK_5A1085641E5D0459 FOREIGN KEY (test_id) REFERENCES test (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE point DROP FOREIGN KEY FK_B7A5F3241E5D0459');
        ...
        $this->addSql('ALTER TABLE side_images DROP FOREIGN KEY FK_3C7152444584665A');
        ...
        $this->addSql('ALTER TABLE vote DROP FOREIGN KEY FK_5A1085641E5D0459');
        ...
        $this->addSql('DROP TABLE side_images');
