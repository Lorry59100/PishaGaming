...
function Account() {
  ...
  const { decodedUserToken, login, userToken } = useTokenService();
    ...
    return (
      <div className="forbidden">
        ...
        {showLoginAndRegisterForm && (
          <LoginAndRegisterForm login={login} onCloseForm={handleCloseForm} />
        )}
      </div>
    );
  }
        ...
        <div className="links-selector">
          <div className="main-links">
            <Link
              ...
              className={
                location.pathname === `${URL_ACCOUNT}${URL_ORDER_HISTORIC}`
                  ? "active"
                  : ""
              }
            >
            ...
            <Link
              ...
              className={
                location.pathname === `${URL_ACCOUNT}${URL_WISHLIST}`
                  ? "active"
                  : ""
              }
            >
            ...
            <Link
              to={`${URL_ACCOUNT}${URL_TESTS}`}
              className={
                location.pathname === `${URL_ACCOUNT}${URL_TESTS}`
                  ? "active"
                  : ""
              }
            >
          ...
          <div className="parameters-link">
            <Link
              ...
              className={
                location.pathname === `${URL_ACCOUNT}${URL_PARAMETERS}`
                  ? "active"
                  : ""
              }
            >
