          ...
          {wishlist && wishlist.product ? (
            <div className="wishlist-user-item">
              <div className="wishlist-platform-img">
                <img
                  src={`${URL_PLATFORM_IMG}/${wishlist.product.platform}.png`}
                  alt={wishlist.product.platform}
                  className="logo-img"
                />
              </div>
              <Link
                to={`${URL_SINGLE_PRODUCT.replace(":id", wishlist.product.id)}`}
              >
                <img
                  src={`${URL}${URL_MAIN_IMG}/${wishlist.product.img}`}
