...
export function Parameters() {
  ...
  const handleImageUpload = (event) => {
    ...
    axios
      .post(`${URL}${URL_USER_UPLOAD_IMG}`, formData, { headers })
      .then((response) => {
  ...
  const handleEmailFormSubmit = (values, actions) => {
    ...
    axios
      .post(
        `${URL}${URL_CHANGE_MAIL}`,
        { mail, mail_confirm, password },
        { headers }
      )
      .catch((error) => {
        console.error(
          "Erreur lors de la soumission du formulaire email :",
          error
        );
      })
      .finally(() => {
  ...
  const handlePseudoFormSubmit = () => {
    ...
    axios
      ...
      .catch((error) => {
        console.error(
          "Erreur lors de la soumission du formulaire pseudo :",
          error
        );
      });
  };
        ...
        <div className="tabs">
          ...
          >
            ...
            <div className="mid-tab">
              ...
              <h4>
                Ajoutez ou modifiez vos adresses de facturation et livraison
              </h4>
            </div>
            <div className="arrow">
              <IoIosArrowForward size="1.5em" color="white" />
          ...
          <div className="profile-update-container">
            <div className="profile-picture-upload">
              ...
              {userData && userData.img ? (
                ...
                >
                  <img
                    src={`${URL}${URL_USER_AVATAR}${userData.img}`}
                    alt="User Image"
            ...
            <div className="profile-pseudo-update">
              ...
              <button
                ...
                type="button"
                onClick={handlePseudoFormSubmit}
              >
                Envoyer
              </button>
            </div>
              ...
              >
                <Form className="email-form-container">
                  ...
                  <Field
                    ...
                    type="text"
                    name="mail_confirm"
                    placeholder="Confirmation de votre nouvelle adresse email"
                  />
                  <Field
                    className="security-form-field"
                    type="password"
          ...
          <div>
            ...
            {addresses.find((address) => address.isActive) && (
              <div className="single-address-container">
                <div>
                  <h3>
                    {addresses.find((address) => address.isActive).firstname}{" "}
                    {addresses.find((address) => address.isActive).lastname}
                  </h3>
                ...
                <h4>
                  {addresses.find((address) => address.isActive).housenumber}{" "}
                  {addresses.find((address) => address.isActive).street}{" "}
                  {addresses.find((address) => address.isActive).postcode}{" "}
                  {addresses.find((address) => address.isActive).city}
                </h4>
              </div>
            )}
